...
public class ResourcePermissionController {
    ...
    @GetMapping
    @PreAuthorize("@perm.has(authentication, 'authorization:list')")
    public ResponseEntity<SuccessResponse> getAll(Pageable pageable) {
        Page<ResourcePermissionResponse> page = service.findAll(pageable);
        ...
        PaginatedResponse<java.util.List<ResourcePermissionResponse>> paginatedResponse = new PaginatedResponse<>(page.getContent(), pagination);
    ...
    public ResponseEntity<SuccessResponse> create(@RequestBody ResourcePermissionRequest request) {
    ...
    public ResponseEntity<SuccessResponse> update(@PathVariable Long id, @RequestBody ResourcePermissionRequest request) {
