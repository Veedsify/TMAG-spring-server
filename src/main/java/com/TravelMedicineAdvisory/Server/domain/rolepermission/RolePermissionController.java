...
public class RolePermissionController {
    ...
    public ResponseEntity<SuccessResponse> getAll(Pageable pageable) {
        Page<RolePermissionResponse> page = service.findAll(pageable);
        ...
        PaginatedResponse<java.util.List<RolePermissionResponse>> paginatedResponse = new PaginatedResponse<>(page.getContent(), pagination);
    ...
    public ResponseEntity<SuccessResponse> create(@RequestBody RolePermissionRequest request) {
    ...
    public ResponseEntity<SuccessResponse> update(@PathVariable Long id, @RequestBody RolePermissionRequest request) {
