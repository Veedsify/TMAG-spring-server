...
public class BlogPostController {
    ...
    @PostMapping
    @PreAuthorize("@perm.has(authentication, 'blog_post:create')")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("@perm.has(authentication, 'blog_post:update')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("@perm.has(authentication, 'blog_post:delete')")
